...
define Package/luci-app-qosv4
  ...
  DEPENDS:=+tc +iptables-mod-conntrack +iptables-mod-conntrack-extra +iptables-mod-filter +iptables-mod-imq +iptables-mod-ipopt +iptables-mod-nat +iptables-utils +iptables-mod-imq +kmod-sched
  PKGARCH:=all
